      ...
      <section className="max-w-7xl mx-auto px-4 py-20 grid md:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <p className="text-gray-600 leading-relaxed mb-6">
            Munira Home начиналась как небольшое семейное ателье. Сегодня мы — это современное производство, специализирующееся на производстве полотенец, халатов и аксессуаров из микрофибры высшего качества.
          </p>
